...
func test_quest_main_scene_uses_spatial_ui_panel() -> void:
	...
	assert_not_null(quest_main.get_node("XROrigin3D/UiPivot/QuestUiLayer/SubViewport/QuestPanel/Panel/Margin/Scroll/VBox/PassthroughToggle"))
	...
	assert_true(_has_boot_phase("UI_PANEL_RECENTERED"))
