...
func test_quest_tutorial_layer_scene_instantiates_viewport_backed_control() -> void:
	var scene: PackedScene = load("res://scenes/shared/quest_tutorial_layer.tscn")
	...
	assert_not_null(panel_layer.get_node("SubViewport/QuestTutorialPanel/Chrome"))
	assert_not_null(panel_layer.get_node("SubViewport/QuestTutorialPanel/Panel/Margin/Scroll/VBox/HideTutorialButton"))
