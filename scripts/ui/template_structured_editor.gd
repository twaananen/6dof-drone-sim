...
@onready var display_name_edit: LineEdit = $Scroll/VBox/MetaGrid/DisplayNameEdit
@onready var slug_edit: LineEdit = $Scroll/VBox/MetaGrid/SlugEdit
@onready var summary_edit: TextEdit = $Scroll/VBox/SummaryEdit
@onready var control_scheme_select: OptionButton = $Scroll/VBox/MetaGrid/ControlSchemeSelect
@onready var difficulty_select: OptionButton = $Scroll/VBox/MetaGrid/DifficultySelect
@onready var beta_recommended_edit: LineEdit = $Scroll/VBox/RecommendationsGrid/BetaRecommendedEdit
@onready var beta_acceptable_edit: LineEdit = $Scroll/VBox/RecommendationsGrid/BetaAcceptableEdit
@onready var beta_avoid_edit: LineEdit = $Scroll/VBox/RecommendationsGrid/BetaAvoidEdit
@onready var beta_notes_edit: TextEdit = $Scroll/VBox/BetaNotesEdit
@onready var liftoff_recommended_edit: LineEdit = $Scroll/VBox/RecommendationsGrid/LiftoffRecommendedEdit
@onready var liftoff_acceptable_edit: LineEdit = $Scroll/VBox/RecommendationsGrid/LiftoffAcceptableEdit
@onready var liftoff_avoid_edit: LineEdit = $Scroll/VBox/RecommendationsGrid/LiftoffAvoidEdit
@onready var liftoff_notes_edit: TextEdit = $Scroll/VBox/LiftoffNotesEdit
@onready var assists_recommended_edit: LineEdit = $Scroll/VBox/RecommendationsGrid/AssistsRecommendedEdit
@onready var assists_optional_edit: LineEdit = $Scroll/VBox/RecommendationsGrid/AssistsOptionalEdit
@onready var assists_avoid_edit: LineEdit = $Scroll/VBox/RecommendationsGrid/AssistsAvoidEdit
@onready var assists_notes_edit: TextEdit = $Scroll/VBox/AssistsNotesEdit
@onready var warnings_edit: TextEdit = $Scroll/VBox/WarningsEdit
@onready var usage_tips_edit: TextEdit = $Scroll/VBox/UsageTipsEdit
@onready var output_select: OptionButton = $Scroll/VBox/OutputToolbar/OutputSelect
@onready var add_binding_button: Button = $Scroll/VBox/OutputToolbar/AddBindingButton
@onready var remove_binding_button: Button = $Scroll/VBox/OutputToolbar/RemoveBindingButton
@onready var binding_list: ItemList = $Scroll/VBox/BindingList
@onready var source_select: OptionButton = $Scroll/VBox/BindingGrid/SourceSelect
@onready var mode_select: OptionButton = $Scroll/VBox/BindingGrid/ModeSelect
@onready var range_min_spin: SpinBox = $Scroll/VBox/BindingGrid/RangeMinSpin
@onready var range_max_spin: SpinBox = $Scroll/VBox/BindingGrid/RangeMaxSpin
@onready var weight_spin: SpinBox = $Scroll/VBox/BindingGrid/WeightSpin
@onready var invert_check: CheckBox = $Scroll/VBox/BindingGrid/InvertCheck
@onready var smoothing_spin: SpinBox = $Scroll/VBox/BindingGrid/SmoothingSpin
@onready var curve_select: OptionButton = $Scroll/VBox/BindingGrid/CurveSelect
@onready var deadzone_spin: SpinBox = $Scroll/VBox/OutputGrid/DeadzoneSpin
@onready var expo_spin: SpinBox = $Scroll/VBox/OutputGrid/ExpoSpin
@onready var sensitivity_spin: SpinBox = $Scroll/VBox/OutputGrid/SensitivitySpin
@onready var invert_output_check: CheckBox = $Scroll/VBox/OutputGrid/InvertOutputCheck
@onready var output_min_spin: SpinBox = $Scroll/VBox/OutputGrid/OutputMinSpin
@onready var output_max_spin: SpinBox = $Scroll/VBox/OutputGrid/OutputMaxSpin
@onready var apply_button: Button = $Scroll/VBox/ActionBar/ApplyButton
@onready var save_button: Button = $Scroll/VBox/ActionBar/SaveButton
